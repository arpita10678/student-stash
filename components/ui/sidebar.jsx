...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md-sidebar-foreground"
        data-state={state}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after-y-0 after-1/2 after-[2px] hover-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]-0 sm",
